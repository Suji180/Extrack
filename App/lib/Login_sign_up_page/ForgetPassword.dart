         ...
         body: Center(
           ...
           child: Column(
             ...
             children:<Widget> [
               ...
               child:  const Text('Account Recovery',style: TextStyle(
               fontSize: 32,
                    ...
                    decoration: BoxDecoration(
                      ...
                      child: TextField(
                          ...
                          if(_invalidMail)
                            ...
                            child:  Text('Enter a valid mail',style: TextStyle(color: Colors.red),)
                            )
                         ]
                          ),
               ...
               Row(
                 ...
                 children: [
                  ...
                  child:ElevatedButton(
                   style: ButtonStyle(
                     backgroundColor: WidgetStateProperty.all(Color.fromARGB(255, 57, 116, 219)),
